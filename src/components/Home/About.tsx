  ...
  return (
    <section id="about" className="px-4 sm:px-6 md:px-8 py-8 md:py-12">
      <div className="max-w-3xl mx-auto md:mx-0 md:ml-8">
        <p className="text-lg">
          Hello, my name is{" "}
          <a className="font-bold text-secondary-300">{NAME}</a>
          ...
          Jose State University. My technical interests include
          <a className="font-bold text-secondary-300">
            math, deep learning, computer vision and overall software
            engineering
          </a>
